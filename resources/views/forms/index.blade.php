            ...
            <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">View and manage all your forms in one place</p>
                    </div>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden items-center justify-center z-50 p-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
            <div class="p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-6">Are you sure you want to delete this form? This action cannot be undone and all associated fields will be deleted.</p>
                <div class="flex justify-end space-x-3">
                    <button id="cancelDelete" class="px-5 py-2.5 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors font-medium">
                        Cancel
                    </button>
                    <form id="deleteForm" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="px-5 py-2.5 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all font-medium shadow-lg">
                            Delete
                        </button>
                    </form>
                </div>
        ...
        $(document).ready(function() {
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <a href="/forms/${data}/export" 
                                       class="btn-action bg-green-600 hover:bg-green-700 text-white shadow-md">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            document.getElementById('deleteForm').addEventListener('submit', function(e) {
                ...
                .then(data => {
                    ...
                    successMsg.className = 'mb-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-l-4 border-green-500 text-green-800 dark:text-green-200 px-5 py-4 rounded-r-lg shadow-md';
                    ...
                    `;
                    document.querySelector('main').insertBefore(successMsg, document.querySelector('main').firstChild);
